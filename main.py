...
def main(page: ft.Page):
    ...
    def update_display(value):
        if text.value in ["*","/", "+"]: #Evita que o display mostre o operador como resultado da conta
            text.value = "0"
        ...
        if calc.count == 0:
            if value == "." and "." in text.value:
                ...
                if calc.num1 == 0.0:
                    ...
                    resultado = operacoes.multiplicacao(calc.num1, float(text.value))
                    calc.num1 = resultado 
                    text.value = resultado
                    calc.count = 1
    ...
    row6 = ft.Row(controls=[ft.ElevatedButton("*", on_click=lambda e: update_display("*")), ft.ElevatedButton("/", on_click=lambda e: update_display("/"))],alignment=ft.MainAxisAlignment.CENTER)
    page.add(
        text,
        row1,
        row2,
